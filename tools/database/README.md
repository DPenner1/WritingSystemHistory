...
*As of 2026-04-16*
  ...
  - *(The vast majority of characters in Unicode are from logographic scripts. These stats are notated "All / Non-Logographic")*. There are ⁨144,611 / 15,540 distinct<sup>1</sup> letters<sup>2</sup> in the database. Of those, 34,340 / 9,070 have a historical ancestor specified (23.7% / 58.4%, including no known ancestor), of which 2468 / 2294 are manually reviewed (1.7% / 14.8%).
  - The database is about 27 MB with minimalistic settings (configurable to keep more data/indexes).
