SELECT *, num_letters - num_derivations AS missing_letters, ROUND(100.0 * num_derivations / num_letters, 2) AS coverage FROM (
	SELECT 
	    script_code, 
...
ORDER BY missing_letters DESC, coverage
